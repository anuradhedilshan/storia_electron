export default function parseAd(data) {
    delete data.images;
    const d = {
        id: data.id,
        market: data.market,
...
function characteristicsFormateData(data) {
    return data["characteristics"].reduce((obj, info) => {
...
function formatData(data, key) {
    return data[key].reduce((obj, info) => {
